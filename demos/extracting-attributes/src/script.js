...
// const gltf = await gltfLoader.loadAsync('/house.glb')
const gltf = await gltfLoader.loadAsync('/house.glb')
...
// const positionsText = Array.from(positions).map(n => n.toFixed(2)).join('\n');
...
// Export color_1 attribute data
// const colorAttribute = baseGeometry.instance.attributes.color_1.array;
// const colorData = Array.from(colorAttribute).map(n => n.toFixed(2)).join('\n');
// const colorData = {
//     array: Array.from(colorAttribute.array),
//     itemSize: colorAttribute.itemSize,
//     normalized: colorAttribute.normalized,
//     count: colorAttribute.count,
//     name: colorAttribute.name,
//     type: colorAttribute.array.constructor.name
// };
...
// const link = document.createElement('a');
// link.href = url;
// link.download = 'color_1_attribute.txt';
// link.click();
// URL.revokeObjectURL(url);


// Export position and color data as binary files
// const positions = baseGeometry.instance.attributes.position.array;
// const colors = baseGeometry.instance.attributes.color_1.array;

// Helper function to save Float32Array as .bin file
// const saveBinaryFile = (array, filename) => {
//     // Create binary blob directly from the TypedArray
...
// // Save both attributes as binary files
// saveBinaryFile(positions, 'positions.bin');
// saveBinaryFile(colors, 'colors.bin');
